            ...
            if table_name == 'unorthodoxforce' or table_name == 'unorthodoxoption':
                ...
                if (table_name == 'unitoption'):
                    with engine.connect() as con:
                        ...
                        con.execute("INSERT INTO unitoption(id, name, details, unit_id, limited) VALUES (350, 'African Warriors Slow Reload to Poorly Equipped', 'Any unit in this Force with the <i>Slow Reload</i> Special Rule may replace it with the <i>Poorly Equipped</i> Special Rule at no cost.', 48, 1)")
                        con.execute("INSERT INTO unitoption(id, name, details, unit_id, limited) VALUES (351, 'Warrior Musketeers Slow Reload to Poorly Equipped', 'Any unit in this Force with the <i>Slow Reload</i> Special Rule may replace it with the <i>Poorly Equipped</i> Special Rule at no cost.', 53, 1)")
                        con.execute("INSERT INTO unitoption(id, name, details, unit_id, limited) VALUES (348, 'Warrior Archers Slow Reload to Poorly Equipped', 'Any unit in this Force with the <i>Slow Reload</i> Special Rule may replace it with the <i>Poorly Equipped</i> Special Rule at no cost.', 64, 1)")
                        con.execute("INSERT INTO unitoption(id, name, details, unit_id, limited) VALUES (349, 'Warriors Slow Reload to Poorly Equipped', 'Any unit in this Force with the <i>Slow Reload</i> Special Rule may replace it with the <i>Poorly Equipped</i> Special Rule at no cost.', 45, 1)")
